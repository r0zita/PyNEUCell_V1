...
model.config.initial_partition_origin = [-1.11692307692308, -1.01538461538462, -0.121846153846154]
model.config.partition_dimension = 2.23384615384615
model.config.subpartition_dimension = 0.0403076923076923

# ---- default configuration overrides ----

model.config.interaction_radius = 3.00000000000000006e-03
model.config.vacancy_search_distance = 0.10000000000000001
# ---- add components ----
